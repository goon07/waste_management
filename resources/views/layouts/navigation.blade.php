            ...
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex md:items-center md:space-x-6">
                    ...
                    @elseif (auth()->user()->role === 'council_admin')
                     ...
                     <a href="{{ route('council.areas.index') }}" class="text-gray-700 hover:text-green-600 px-3 py-2 rounded-md text-sm font-medium {{ request()->routeIs('council.areas.*') ? 'border-b-2 border-green-600' : '' }}">
    Areas
</a>
